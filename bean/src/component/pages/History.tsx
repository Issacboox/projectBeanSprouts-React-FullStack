        ...
        <div className="col-md-2">
          <div className="mb-3">
            ...
            <select className="form-select" id="exampleFormControlSelect1">
              ...
              <option value="option2">จัดส่งสำเร็จ</option>
              <option value="option3">ยกเลิก</option>
            </select>
          </div>
        </div>
      </div>
              ...
              <div className="top-order d-flex justify-content-between align-items-center">
                <div className="d-flex gap-3 flex-start">
                  <img
                    ...
                    alt=""
                  />
                  <p className="topic-order mt-2">#SPR03</p>
                </div>
                <div className="status-order" style={{ backgroundColor: '#fdff28' }}>
                  <p>จัดส่งสำเร็จ</p>
                </div>
              </div>
              ...
              <div className="top-order d-flex justify-content-between align-items-center">
                <div className="d-flex gap-3 flex-start">
                  <img
                    ...
                    alt=""
                  />
                  <p className="topic-order mt-2">#SPR04</p>
                </div>
                <div className="status-order" style={{ backgroundColor: 'red' }}>
